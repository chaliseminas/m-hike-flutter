...
class EditHikePagePage extends StatefulWidget {

  final HikeModel data;
  EditHikePagePage({Key? key, required this.data}) : super(key: key);

  @override
  State<EditHikePagePage> createState() => _EditHikePagePageState();
}

class _EditHikePagePageState extends State<EditHikePagePage> {
  ...
  @override
  void initState() {
    _nameTextEditingController.text = widget.data.name.toString();
    _locationTextEditingController.text = widget.data.location.toString();
    _hikeDateTextEditingController.text = widget.data.date.toString();
    _parkingAvailableTextEditingController.text = widget.data.parking.toString();
    _lengthTextEditingController.text = widget.data.length.toString();
    _difficultyTextEditingController.text = widget.data.difficulty.toString();
    _accommodationTextEditingController.text = widget.data.accommodation.toString();
    _personLimitTextEditingController.text = widget.data.personLimit.toString();
    _descriptionTextEditingController.text = widget.data.description.toString();
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Edit hike details"),
      ),
      body: Padding(
  ...
  handleDataSave() {
    ...
    if (name.isEmpty) {
      ...
      Provider.of<MainViewModel>(context, listen: false).update(context, data);
    }
  }
